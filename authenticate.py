...
p.add_argument("--disable_keyring", action="store_false", help="Disable keyring storage")

args = p.parse_args()
pwd = getpass(f"Enter password ({args.username}@{args.hostname}): ")

set_credentials(args.hostname, args.username, pwd, use_keyring=args.disable_keyring)